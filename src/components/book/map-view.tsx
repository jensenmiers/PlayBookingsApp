    ...
    <div className="min-h-screen bg-secondary-50 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        <div className="mb-6 flex justify-center">
          <div className="bg-secondary-200 rounded-full p-6">
            <FontAwesomeIcon icon={faMap} className="text-4xl text-secondary-600" />
          </div>
        </div>
        <h2 className="text-2xl font-bold text-secondary-800 mb-3">Map View Coming Soon</h2>
        ...
        <div className="bg-white rounded-2xl shadow-soft p-6 text-left">
          <h3 className="font-semibold text-secondary-800 mb-2">Planned Features:</h3>

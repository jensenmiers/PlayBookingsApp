    ...
    <div className="bg-secondary-800 rounded-2xl shadow-soft p-2xl text-center">
      <div className="space-y-4">
        <div className="text-secondary-50/60">
          <p className="text-lg font-medium mb-s">No available times today</p>
        ...
        {onViewTomorrow && (
          <Button
            ...
            className="bg-secondary-600 hover:bg-secondary-700 text-secondary-50 font-medium py-s px-xl rounded-xl transition duration-200"
          >
            View Tomorrow
          </Button>
        )}

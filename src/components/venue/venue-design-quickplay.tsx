...
export function VenueDesignQuickplay({ venue }: VenueDesignQuickplayProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-secondary-900 via-secondary-900 to-secondary-800">
      ...
      {/* Day Selector Pills */}
      <div className="px-l py-m overflow-x-auto scrollbar-hide">
          ...
          {days.map((day, i) => {
            ...
            return (
              <button
                ...
                className={`flex-shrink-0 px-l py-s rounded-full text-sm font-medium transition-all ${
                  selectedDay === i
              ...
              >
                ...
                {selectedDay !== i && (
                  <span className="block text-[10px] opacity-70 mt-xxs">{day.shortDate}</span>
                )}
              </button>
            )
          })}
      ...
      <div className="px-l py-s">
        {loading ? (
          ...
          <div className="text-center py-2xl text-secondary-50/50">
            <p className="text-sm">No available slots for this day</p>
          </div>
        ) : (
          <div
            ref={slotsRef}
            className="flex gap-m overflow-x-auto pb-s snap-x snap-mandatory scrollbar-hide"
          >
            {selectedDaySlots.map((slot, idx) => {
              ...
              return (
                <button
                  ...
                  className={`flex-shrink-0 w-24 snap-start rounded-2xl p-m transition-all duration-200 ${
                    isSelected
                ...
                >
                  ...
                  <div className={`text-xs mt-xs ${isSelected ? 'text-secondary-900/70' : 'opacity-60'}`}>
      ...
      <div className="px-l py-xl mt-l">
        {selectedSlot ? (
          ...
          >
            ...
            <FontAwesomeIcon icon={faChevronRight} className="ml-s" />
          </Button>
        ) : (
      ...
      {/* Venue Info Footer */}
      <div className="px-l pb-2xl space-y-4">
        {/* Address */}
        <GoogleMapsLink
        ...
        {venue.amenities && venue.amenities.length > 0 && (
          <div className="flex flex-wrap gap-s">
            ...
            {venue.amenities.length > 4 && (
              <span className="px-m py-xs text-secondary-50/40 text-xs">

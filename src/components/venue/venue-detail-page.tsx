      ...
      <div className="px-4 py-6 max-w-6xl mx-auto">
        ...
        <div className="bg-secondary-800 rounded-2xl shadow-soft overflow-hidden mb-6">
          ...
          {primaryPhoto ? (
            ...
            <div className="w-full h-64 md:h-96 bg-secondary-50/5 flex items-center justify-center">
              <span className="text-secondary-50/40 text-lg">No Image Available</span>
            </div>
          )}

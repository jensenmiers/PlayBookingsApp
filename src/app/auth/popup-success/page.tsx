  ...
  if (status === 'error') {
    return (
      <div className="flex min-h-screen items-center justify-center bg-background p-l">
        <div className="mx-auto max-w-md space-y-4 rounded-2xl border border-secondary-50/10 bg-secondary-800 p-2xl text-center shadow-soft">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-s rounded-xl bg-primary-400 px-xl py-s text-sm font-semibold text-secondary-900 transition-colors hover:bg-primary-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 focus-visible:ring-offset-2"
          >
            Try Again
          </button>
        </div>

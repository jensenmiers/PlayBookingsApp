...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="relative flex flex-col h-[calc(100dvh-4rem)] min-h-[calc(100dvh-4rem)] sm:min-h-screen sm:h-auto">
        ...
        <div className="absolute bottom-0 right-0 w-1/3 h-1 bg-gradient-to-r from-transparent via-accent-400 to-primary-400 shrink-0" />
      </section>

...
function VerticalCompactCourtCard({
  ...
  return (
    ...
    >
      ...
      >
        {/* Flexible image area — fills available space so 3 cards fit in viewport */}
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="relative flex flex-col h-[calc(100dvh-4rem)] min-h-[calc(100dvh-4rem)] lg:flex-row">
        ...
        {/* OPTION 4: 55/45 split with tighter headline */}
        ...
        {/* OPTION 4: 45% width, vertical compact cards, 3 cards — fill height */}

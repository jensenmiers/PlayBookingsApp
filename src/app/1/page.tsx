...
function SidebarCourtCard({
  ...
  return (
    ...
    >
      ...
      >
        {/* OPTION 1 CHANGE: w-28 xl:w-32 → w-36 xl:w-40 */}
        ...
        {/* OPTION 1 CHANGE: p-3 → p-4 */}
        <div className="flex-1 min-w-0 p-4 flex flex-col justify-center">
          {/* OPTION 1 CHANGE: text-base → text-lg */}
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="relative flex flex-col h-[calc(100dvh-4rem)] min-h-[calc(100dvh-4rem)] lg:flex-row">
        ...
        {/* OPTION 1 CHANGE: lg:px-6 xl:px-10 → lg:px-8 xl:px-12, gap-3 → gap-4 */}
        <div className="relative hidden lg:flex lg:w-[40%] lg:flex-col lg:justify-center lg:px-8 lg:py-8 xl:px-12">
          <div className="absolute inset-0 bg-secondary-900/60 backdrop-blur-sm" />

          {/* OPTION 1 CHANGE: gap-3 → gap-4 */}

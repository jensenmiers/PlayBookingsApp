-- Keep venue discovery aligned with exact elapsed minimum-advance policy.
-- The original exact-minimum-advance migration updated the canonical regular
-- slot eligibility function; this forward migration reapplies the discovery
-- RPC through that shared eligibility source for already-migrated projects.
